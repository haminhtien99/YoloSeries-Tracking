'''
src: xuarehere/yolo_series_deepsort_pytorch
Author: xuarehere
Date: 
LastEditTime: 
...
def main():
    ...
    parser.add_argument(
        "--data_dir", default="/home/ha/Downloads/Dataset/market-1501/Market-1501-v15.09.15", help="dataset directory", type=str
    )
