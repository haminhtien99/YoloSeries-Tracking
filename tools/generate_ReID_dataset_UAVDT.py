...
split_train_test = ['train', 'val']
data_path = '/home/ha/Downloads/Dataset/UAVDT-MOT'
# Create folder for outputs
save_path = '/home/ha/Downloads/Dataset/Fast-ReID/UAVDT-ReID'
...
for split in split_train_test:
    ...
    for seq in sequences:
        ...
        ground_truth_path = os.path.join(split_data_path, 'gt_whole', seq + '_gt_whole.txt')
