...
import argparse
DEST_FOLDER = '/home/ha/projects/YoloSeries-Tracking/results/data/gt'
def main(args):
    ...
    for spl_set in splits_set:
        ...
        # copy gt files and seqinfo.ini to results/data/gt
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='copy data to results directory')
