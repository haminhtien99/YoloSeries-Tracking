...
def _resnet(arch, block, layers, pretrained, progress, reid=False, num_classes=1000, **kwargs):
    model = ResNet(block, layers, reid=reid, num_classes=num_classes, **kwargs)
...
def resnet152(pretrained=False, progress=True, reid=False, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet152', Bottleneck, [3, 8, 36, 3], pretrained, progress, reid,
                   **kwargs)



def resnext50_32x4d(num_classes, pretrained=False, progress=True, reid=False, **kwargs):
    ...
    return _resnet('resnext50_32x4d', Bottleneck, [3, 4, 6, 3],
                   pretrained, progress, reid=reid, num_classes=num_classes, **kwargs)



def resnext101_32x8d(pretrained=False, progress=True, reid=False, **kwargs):
    ...
    return _resnet('resnext101_32x8d', Bottleneck, [3, 4, 23, 3],
                   pretrained, progress, reid, **kwargs)



def wide_resnet50_2(pretrained=False, progress=True, reid=False, **kwargs):
...
def wide_resnet101_2(pretrained=False, progress=True, reid=False, **kwargs):
