...
def resnet18_ibn_a(pretrained=False, reid=False, **kwargs):
...
def resnet34_ibn_a(pretrained=False, reid=False, **kwargs):
...
def resnet50_ibn_a(pretrained=False, reid=False, **kwargs):
...
def resnet101_ibn_a(pretrained=False, reid=False, **kwargs):
...
def resnet152_ibn_a(pretrained=False, reid=False, **kwargs):
...
def resnet18_ibn_b(pretrained=False, reid=False, **kwargs):
...
def resnet34_ibn_b(pretrained=False, reid=False, **kwargs):
...
def resnet50_ibn_b(pretrained=False, reid=False, **kwargs):
...
def resnet101_ibn_b(pretrained=False, reid=False,**kwargs):
...
def resnet152_ibn_b(pretrained=False, reid=False, **kwargs):
