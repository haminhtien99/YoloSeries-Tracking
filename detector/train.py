...
if __name__ == '__main__':
    ...
    parser.add_argument('--model-weight', type=str,
                        default='detector/pretrained_weights/yolov8n.pt', help='')
    parser.add_argument('--data', type=str,
                        default='data-config/visdrone-local.yaml', help='')
    ...
    parser.add_argument('--name', type=str, default='yolov8/exp',
                        help='name of ouput folder')
    parser.add_argument('--project', type=str, default='detector/ultralytics/runs',
